// ============================================================
// REDE HUD - Floating HUD Overlay Component (Standalone)
...
import type { HudSize, HudPosition } from "../types";
...
export const FloatingHUD: React.FC = () => {
  ...
  const hudSize = useHudSettingsStore((s) => s.settings.hud_size);
  const hudPosition = useHudSettingsStore((s) => s.settings.hud_position);
  const showGlow = useHudSettingsStore((s) => s.settings.show_glow);
  const showStats = useHudSettingsStore((s) => s.settings.show_stats);
